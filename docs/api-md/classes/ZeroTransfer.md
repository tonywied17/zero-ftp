...
Defined in: [src/client/ZeroTransfer.ts:62](https://github.com/tonywied17/zero-transfer/blob/f871bd1a1c01caee1df080b7e6cf2b4686fe7ef7/src/client/ZeroTransfer.ts#L62)
...
Defined in: [src/client/ZeroTransfer.ts:78](https://github.com/tonywied17/zero-transfer/blob/f871bd1a1c01caee1df080b7e6cf2b4686fe7ef7/src/client/ZeroTransfer.ts#L78)
...
Defined in: [src/client/ZeroTransfer.ts:103](https://github.com/tonywied17/zero-transfer/blob/f871bd1a1c01caee1df080b7e6cf2b4686fe7ef7/src/client/ZeroTransfer.ts#L103)
...
Defined in: [src/client/ZeroTransfer.ts:131](https://github.com/tonywied17/zero-transfer/blob/f871bd1a1c01caee1df080b7e6cf2b4686fe7ef7/src/client/ZeroTransfer.ts#L131)
...
Defined in: [src/client/ZeroTransfer.ts:91](https://github.com/tonywied17/zero-transfer/blob/f871bd1a1c01caee1df080b7e6cf2b4686fe7ef7/src/client/ZeroTransfer.ts#L91)
...
Defined in: [src/client/ZeroTransfer.ts:158](https://github.com/tonywied17/zero-transfer/blob/f871bd1a1c01caee1df080b7e6cf2b4686fe7ef7/src/client/ZeroTransfer.ts#L158)
...
Defined in: [src/client/ZeroTransfer.ts:181](https://github.com/tonywied17/zero-transfer/blob/f871bd1a1c01caee1df080b7e6cf2b4686fe7ef7/src/client/ZeroTransfer.ts#L181)
...
Defined in: [src/client/ZeroTransfer.ts:172](https://github.com/tonywied17/zero-transfer/blob/f871bd1a1c01caee1df080b7e6cf2b4686fe7ef7/src/client/ZeroTransfer.ts#L172)
...
Defined in: [src/client/ZeroTransfer.ts:196](https://github.com/tonywied17/zero-transfer/blob/f871bd1a1c01caee1df080b7e6cf2b4686fe7ef7/src/client/ZeroTransfer.ts#L196)
...
Defined in: [src/client/ZeroTransfer.ts:208](https://github.com/tonywied17/zero-transfer/blob/f871bd1a1c01caee1df080b7e6cf2b4686fe7ef7/src/client/ZeroTransfer.ts#L208)
...
| ------ | ------ | ------ | ------ | ------ | ------ |
| <a id="createtransferclient"></a> `createTransferClient` | `readonly` | (`options`) => [`TransferClient`](TransferClient.md) | `createTransferClient` | Creates a provider-neutral transfer client with the built-in provider registry. | [src/client/ZeroTransfer.ts:64](https://github.com/tonywied17/zero-transfer/blob/f871bd1a1c01caee1df080b7e6cf2b4686fe7ef7/src/client/ZeroTransfer.ts#L64) |
| <a id="protocol"></a> `protocol` | `readonly` | `"ftp"` \| `"ftps"` \| `"sftp"` | `undefined` | Protocol selected for this client instance. | [src/client/ZeroTransfer.ts:67](https://github.com/tonywied17/zero-transfer/blob/f871bd1a1c01caee1df080b7e6cf2b4686fe7ef7/src/client/ZeroTransfer.ts#L67) |
