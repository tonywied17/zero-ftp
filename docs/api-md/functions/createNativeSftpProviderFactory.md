...
[ZeroTransfer SDK](../README.md) / createNativeSftpProviderFactory

# Function: createNativeSftpProviderFactory()

```ts
function createNativeSftpProviderFactory(options?): ProviderFactory;
```

Defined in: src/providers/native/sftp/NativeSftpProvider.ts:225
...
| Parameter | Type |
| ------ | ------ |
| `options` | [`NativeSftpProviderOptions`](../interfaces/NativeSftpProviderOptions.md) |
