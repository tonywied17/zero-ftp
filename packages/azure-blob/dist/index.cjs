...
// src/entries/azure-blob.ts
var azure_blob_exports = {};
__export(azure_blob_exports, {
...
module.exports = __toCommonJS(azure_blob_exports);
...
function generateUploadNonce() {
  return (0, import_node_crypto2.randomBytes)(4).toString("hex");
}
